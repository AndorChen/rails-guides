...
如果没有禁用 Asset Pipeline，link:https://github.com/rails/rails/tree/master/actionview/app/assets/javascripts[rails-ujs] 负责提供 JavaScript 代码，常规的 Ruby 视图辅助方法负责生成 DOM 标签。
