...
如果在 Ruby on Rails 的link:https://github.com/svenfuchs/rails-i18n/tree/master/rails/locale[示例翻译数据]库中没找到想要的区域设置（语言），可以link:https://github.com/guides/fork-a-project-and-submit-your-modifications[派生仓库]，添加翻译数据，然后发送link:https://github.com/guides/pull-requests[拉取请求]。
