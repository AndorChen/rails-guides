...
关于 `count` 方法的选项的更多介绍，请参阅 <<active_record_querying#calculations>>。
...
关于 `average` 方法的选项的更多介绍，请参阅 <<active_record_querying#calculations>>。
...
关于 `minimum` 方法的选项的更多介绍，请参阅 <<active_record_querying#calculations>>。
...
关于 `maximum` 方法的选项的更多介绍，请参阅 <<active_record_querying#calculations>>。
...
关于 `sum` 方法的选项的更多介绍，请参阅 <<active_record_querying#calculations>>。
...
预先加载在底层可能会触发多次查询，有的查询可能需要使用之前查询的结果。因此，`explain` 方法实际上先执行了查询，然后询问查询计划。例如：
